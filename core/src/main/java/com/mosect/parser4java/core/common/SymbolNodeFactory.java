...
public class SymbolNodeFactory implements NodeFactory {
    ...
    private final Map<String, SymbolToken> symbolTokenMap = new TreeMap<>();
    ...
    @Override
    public SymbolToken parse(ParentParser parentParser, TextSource source, List<ParseError> outErrors) throws ParseException {
